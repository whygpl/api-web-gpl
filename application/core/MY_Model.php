...
class MY_Model extends CI_Model 
{
	...
	*/
	...
	public function dataTable_Report( $primaryKey = '0', $column = array(), $columnDefs = array(), $where1 = 0, $where2 = 0) {
		$return = array(
			"draw" => 1,
			"recordsTotal" => 0,
			"recordsFiltered" => 0,
	...
	public function dataTable_Pendaftaran( $primaryKey = '0', $column = array(), $columnDefs = array() ) {
		$return = array(
			"draw" => 1,
			"recordsTotal" => 0,
			"recordsFiltered" => 0,
 ...
 */
	...
	public function removetype($id = 0,$whereFields = 0) {
        $sts = false;
